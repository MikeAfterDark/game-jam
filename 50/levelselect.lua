LevelSelect = Object:extend()
LevelSelect:implement(State)
LevelSelect:implement(GameObject)
function LevelSelect:init(name)
	self:init_state(name)
	self:init_game_object()
end

function LevelSelect:on_enter(from)
	slow_amount = 1
