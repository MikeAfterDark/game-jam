...
function Input:init(joystick_index)
	...
	self.gamepad_buttons =
		{ "fdown", "fup", "fleft", "fright", "dpdown", "dpup", "dpleft", "dpright", "start", "back", "guide", "leftstick", "rightstick", "rb", "lb" }
	...
	self.index_to_gamepad_axis =
		{ ["leftx"] = "leftx", ["rightx"] = "rightx", ["lefty"] = "lefty", ["righty"] = "righty", ["triggerleft"] = "lt", ["triggerright"] = "rt" }
	self.gamepad_axis = {}
...
function Input:bind_all()
	...
	for k, v in pairs(keyboard_binds) do
		self:bind(k, v)
	end
	self:bind("m1", { "m1" })
	self:bind("m2", { "m2" })
